...
export function FAQ() {
    ...
    function handleCopy() {
        ...
        },
        {
            ...
            answer: <p>We welcome contributions! Please check our <a href="https://github.com/Adam-Elmi/CopyShare.docs.git" className='text-blue-400'>GitHub repository</a> for guidelines on contributing, reporting issues, or submitting feature requests.</p>
        },
    ];
